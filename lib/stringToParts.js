...
exports.stringToParts = function(str) {
  if (cache) {
    if (cache.has(str)) {
      return cache.get(str);
    }
    cache.set(str, _stringToParts(str));
    return cache.get(str);
  }
  return _stringToParts(str);
};

exports.setTokenizerCache = function(tokenizerCache) {
